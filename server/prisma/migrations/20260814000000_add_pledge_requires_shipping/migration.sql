...
INSERT INTO "new_PendingPledge" ("checkout_session_id", "checkout_url", "comment", "created_at", "donor_email", "expires_at", "fulfilled_by_donation_id", "id", "pledge_token", "status", "top_up_cents", "total_cents", "updated_at", "wallet_discount_cents") SELECT "checkout_session_id", "checkout_url", "comment", "created_at", "donor_email", "expires_at", "fulfilled_by_donation_id", "id", "pledge_token", "status", "top_up_cents", "total_cents", "updated_at", "wallet_discount_cents" FROM "PendingPledge";
